class Map {
    ...
    __level2Map(i, j, maxi, maxj, step) {
        return (i === 0 || j === 0 || (j + step + step) >= maxj || (i + step + step) >= maxi
            || (j >= round(maxj / 3) && j <= round(maxj / 2.5) && i >= round(maxi / 3) && i <= round(maxi / 2.3))
            || (j >= round(maxj / 0.36) && j <= round(maxj / 0.3) && i >= round(maxi / 3) && i <= round(maxi / 0.3)));
    }
    ...
    __level4Map(i, j, maxi, maxj, step) {
        return (i === 0 || j === 0 || (j + step + step) >= maxj || (i + step + step) >= maxi
            || (j >= round(maxj / 6) && j <= round(maxj / 3) && i >= round(maxi / 6) && i <= round(maxi / 3))
            || (j >= round(maxj / 3) && j <= round(maxj / 2.5) && i >= round(maxi / 2))
            || (j >= round(maxj / 5.36) && j <= round(maxj / 4.3) && i >= round(maxi / 1.3))
            || (j >= round(maxj / 2) && j <= round(maxj / 1.5) && i >= round(maxi / 15) && i <= round(maxi / 5.3))
            || (j >= round(maxj / 1.36) && j <= round(maxj / 1.3) && i >= round(maxi / 4) && i <= round(maxi / 1.3)));
    }
